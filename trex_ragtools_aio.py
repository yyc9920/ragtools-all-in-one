...
def getArgs():
    ...
    parser.add_argument('--json_config', type=str, help=" : load json configuration instead of typing all of the arguments")
    parser.add_argument('--action', type=str, help=f" : set the type of action you want.\
    ...
    parser.add_argument('--eval_result_filename', type=str, help=' : path to save the generated evaluation result')
...
generateContext
    ...
    arguments:
        ...
        --testset_filename (str): The path to save the generated context file.
            """)
        elif args.action == 'evaluateTestset':
            print("""
evaluateTestset
    ...
    about ragas metrics : https://docs.ragas.io/en/v0.2.1/concepts/metrics/available_metrics/
